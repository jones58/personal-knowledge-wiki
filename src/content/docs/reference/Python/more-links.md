...
- [Python Tutorial for Beginners (with mini-projects) - YouTube](https://www.youtube.com/watch?v=qwAFL1597eM)
- [Learn Python For Free - Interactive Tutorial](https://scrimba.com/learn/python)
...
- [Python Tutor code visualizer- Visualize code in Python, JavaScript, C, C++, and Java](https://pythontutor.com/visualize.html#mode=display)
