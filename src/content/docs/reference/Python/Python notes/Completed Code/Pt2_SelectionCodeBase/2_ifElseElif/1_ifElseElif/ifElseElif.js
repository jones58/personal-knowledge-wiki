...
let score = parseInt(prompt("Enter a number: ")) // int(input("Enter a number{} ")) // score variable global scope
...
else if (score >=60 && score <=74){// reassign the grade variable the value B
    grade = "B"}
...
console.log(`You have scored ${score} and your grade is ${grade}`)
document.write(`You have scored ${score} and your grade is ${grade}`)
...
"Make"
"To Do{} Task {} Using if else if and else"
