...
print( 2+ 3)   # Modify to use a different operator
print( 12 / 2)   # Modify to use a different operator
print(2 + 3 * 5 /2)  # Make : Use a different number and/or operator
...
print("The answer to " + str(myNum1) + " x " +  str(myNum2) +  "=" , myNum1 * myNum2)
