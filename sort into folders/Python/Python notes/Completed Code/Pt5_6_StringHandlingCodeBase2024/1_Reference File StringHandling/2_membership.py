...
# name = "Firstname Lastname"  # Add your name in between the speech marks 
# aChar = "a"
# if aChar in name:
#     print(f"Found {aChar}")
# else:
...
name = "james Bond" # Add your name in between the speech marks 

for aChar in name: # aChar =  "a", "e", "i", "o", "u", "j"

    if aChar in vowels: # aChar =  J/a/m/e/s/ /B/o/n/d
        print(f"found {aChar}")
    else:
        print(f"Not found {aChar}")
